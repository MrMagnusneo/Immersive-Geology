...
public class IGMenuTypes
{
	...
	public static final DeferredHolder<?, MenuType<IGCrateMenu>> CRATE = registerSimple(IGLib.GUIID_Crate, IGCrateMenu::new);

	public static <M extends AbstractContainerMenu>
	DeferredHolder<?, MenuType<M>> registerSimple(String name, SimpleContainerConstructor<M> factory)
	{
	...
	{
		DeferredHolder<?, MenuType<C>> typeRef = registerType(name, client);
	...
	{
		DeferredHolder<?, MenuType<C>> typeRef = REGISTER.register(
				name, () -> {
	...
	{
		private MultiblockContainer(DeferredHolder<?, MenuType<C>> type, ArgContainerConstructor<IEContainerMenu.MultiblockMenuContext<S>, C> factory) {
			super(type, factory);
		}
	...
	public static class ArgContainer<T, C extends IEContainerMenu> {
		private final DeferredHolder<?, MenuType<C>> type;
		private final ArgContainerConstructor<T, C> factory;

		private ArgContainer(DeferredHolder<?, MenuType<C>> type, ArgContainerConstructor<T, C> factory) {
			this.type = type;
	...
	private static <C extends IEContainerMenu> DeferredHolder<?, MenuType<C>> registerType(String name, ClientContainerConstructor<C> client) {
