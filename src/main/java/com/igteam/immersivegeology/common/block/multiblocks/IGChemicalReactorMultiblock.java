...
public class IGChemicalReactorMultiblock extends IGTemplateMultiblock
{
	...
	{
		super(ResourceLocation.fromNamespaceAndPath(IGLib.MODID, "multiblocks/chemical_reactor"), new BlockPos(4,0,4), new BlockPos(5,1,6), new BlockPos(9,6,9), IGMultiblockProvider.CHEMICAL_REACTOR);
	}
