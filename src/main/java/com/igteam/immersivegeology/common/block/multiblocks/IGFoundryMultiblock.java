...
public class IGFoundryMultiblock extends IGTemplateMultiblock {
	...
	public IGFoundryMultiblock() {
		super(ResourceLocation.fromNamespaceAndPath(IGLib.MODID, "multiblocks/foundry"), new BlockPos(2,0,0), new BlockPos(0,1,1), new BlockPos(3, 3, 2), IGMultiblockProvider.FOUNDRY);
	}
