...
public class IGPelletizerMultiblock extends IGTemplateMultiblock
{
	...
	{
		super(ResourceLocation.fromNamespaceAndPath(IGLib.MODID, "multiblocks/pelletizer"), new BlockPos(1, 0, 1), new BlockPos(0,1,3), new BlockPos(3,3,4), IGMultiblockProvider.PELLETIZER);
	}
